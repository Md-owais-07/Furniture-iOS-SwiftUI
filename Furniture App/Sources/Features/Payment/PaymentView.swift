...
struct PaymentView: View {
    ...
    let paymentMethod: CheckoutModel
    
    var body: some View {
        if paymentMethod.title == "Paypal" {
            Text("Coming soon...Paypal")
                .font(.subheadline)
        } else if paymentMethod.title == "Apple Pay" {
            Text("Coming soon...Apple Pay")
                .font(.subheadline)
        } else {
            ZStack {
...
#Preview {
    PaymentView(paymentMethod: checkoutData[0])
